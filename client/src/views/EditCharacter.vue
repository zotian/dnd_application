  ...
  <div class='container mt-3 text-center'>
    <form accept-charset="ISO-8859-1">
      ...
      <div class="form-group smallDisplay row mb-0">
        ...
        <div class="col-sm-2 col-4 mb-1 divPersonalDisplayMedia spinnersOn spinnersOff">
          <input
            type="number"
            name='level'
            class="personalInput form-control inputStyle4 h6DisplayMedia mb-0 pr-2 pl-1"
      ...
      <div class='row mt-5 pb-4'>
        ...
        <!-- ABILITIES SCORE -->
        <div class='col-md-1 col-2 divDisplayMedia2 spinnersOn spinnersOff'>
          <ul >
        ...
        <!-- ABILITY MODIFIER -->
        <div class='col-md-1 col-2 divDisplayMedia2 spinnersOff'>
          <ul>
            <small class="form-text smallDisplayMedia"
      ...
      <div class='mt-5 mb-5'>
        <router-link v-bind:to="{ name:'Characters'}">
          <a href="#">
            <button @click='redirectAtTop()' class='btn btn-info mr-2'>Go back</button>
          </a>
        </router-link>
        <router-link v-bind:to="{ name:'ShowCharacter'}">
          <a href="#">
            <button @click='redirectAtTop()' class='btn btn-primary mr-2'>Show Character</button>
          </a>
        </router-link>
        <button class='btn btn-success'  @click.prevent="updateCharInfo">Update</button>
      </div>
...
export default {
    ...
    methods:{
        async getCharInfo(){
            ...
            this.spentPoints= response.data.spentPoints,
            this.unspentPoints= response.data.unspentPoints,
        ...
        async updateCharInfo(){
            await PostsService.updateCharInfo({
                id: this.$route.params.id,
                title: this.title,
             ...
             await this.$router.push({ path: '/characters/' + this.$route.params.id});
